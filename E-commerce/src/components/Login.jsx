...
const Login = ()=>{
    ...
    return( 
        <div className="grid md:grid-cols-2 md:h-screen md:overflow-hidden ">
            <img src="/images/loginPage.jpg" className="w-full md:h-full h-24 object-cover animate__animated animate__backInLeft"/>
            <div className="flex flex-col md:p-16 p-8 animate__animated animate__backInRight">
                <h1 className="text-4xl font-bold">Signin</h1>
                <p className="text-lg text-gray-600 mt-2">Enter profile Details to login</p>
